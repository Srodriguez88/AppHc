        ...
        <div class="row">
          ...
          <div class="col col s8 m8 l8">
            <ul id="profile-dropdown-nav" class="dropdown-content">
              ...
              <li>
                <a href="#" class="grey-text text-darken-1">
                  <i class="material-icons">lock_outline</i> Salir</a>
              </li>                 
            </ul>
            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown-nav">Juan<i class="mdi-navigation-arrow-drop-down right"></i></a>
